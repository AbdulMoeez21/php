<div class="sticky">
                ...
                <div class="app-sidebar">
                    <div class="side-header">
                        <a class="header-brand1" href="/login/BlogWebsite/index.php">
                        ...
                        <ul class="side-menu">
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    ...
                                    <li><a href="create-blog.php" class="slide-item"> Create Blog</a></li>
                                    <li><a href="view-blog.php" class="slide-item"> View Blogs</a></li>
